<script type="text/javascript" src="<?php echo base_url('assets/tinymce/tinymce.min.js');?>"></script>
  ...
  <?php
        echo form_open_multipart('c_admin/berita_update/'.$berita['id_berita']);
         ?>
<div class="container">
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="form-group">
        ...
        <?php
      	$txtpenulis = array('name' => 'penulis', 'class' => 'form-control', 'autofocus' => 'autofocus', 'value' => $berita['penulis']);
      	echo form_input($txtpenulis);
      	?>
      </div>
      <div class="form-group">
        <label for='judul'>Judul</label>
      	<?php  $txtjudul = array('name' => 'judul', 'class' => 'form-control', 'autofocus' => 'autofocus', 'value' => $berita['judul']);
      	echo form_input($txtjudul);
      	?>
      </div>
      <div class="form-group">
        <label for="isi">Isi</label>
        <?php $txtisi = array('name' => 'isi', 'class' => 'form-control', 'autofocus' => 'autofocus', 'id' => 'mytextarea', 'value' => $berita['isi']);
